	...
	<body>
		<div class="wrapper">
			<div class="container-fluid">
				...
				<div class="row-fuid">&nbsp;</div><div class="row-fuid">&nbsp;</div><div class="row-fuid">&nbsp;</div><div class="row-fuid">&nbsp;</div><div class="row-fuid">&nbsp;</div>
				...
				<div class="row-fluid">
					<div class="span4 ">
						...
						<div class="row-fluid text-right">
							<a href="<?php echo site_url("/search");?>">Search & Find</a>
						</div>
						...
						<div class="row-fluid text-right">
							<a href="<?php echo site_url("/add");?>">Add</a>
						</div>
					</div>
